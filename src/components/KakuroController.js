...
class KakuroController extends React.Component {
      ...
      <div className="kakuro">
        <div className="kakuro-controller">
          ...
          {this.state.focusCell && (
            <CellDetails focusCell={this.state.focusCell} />
          )}
        </div>
        {this.props.goBack && (
          <button onClick={this.props.goBack} className="go-back-button">
            Go Back
          </button>
        )}
      </div>
  ...
  validateSolution() {
    ...
    if (invalidDownSums.length === 0 && invalidRightSums.length === 0) {
      ...
      toast.success(
        "The solution is valid and you took " +
      ...
      toast.error(
        "The solution is invalid and you took " +
          this.state.elapsedTime +
          " seconds to try to solve it!"
      );
    }
  }
    ...
    return (
      <div class="kakuro">
        ...
        <input
          ...
          onClick={this.validateSolution.bind(this)}
        />
      </div>
    );
  }
